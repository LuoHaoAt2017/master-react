  ...
  var ReactNoop = {
    ...
    getOrCreateRootContainer: function () {
      ...
      if (!root) {
        ...
        root = NoopRenderer.createContainer(container, tag, null, null, false, '', onRecoverableError);
    ...
    createRoot: function (options) {
      ...
      var fiberRoot = NoopRenderer.createContainer(container, constants.ConcurrentRoot, null, null, false, '', onRecoverableError, options && options.transitionCallbacks ? options.transitionCallbacks : null);
      return {
        _Scheduler: Scheduler,
    ...
    createLegacyRoot: function () {
      ...
      var fiberRoot = NoopRenderer.createContainer(container, constants.LegacyRoot, null, null, false, '', onRecoverableError);
      return {
        _Scheduler: Scheduler,
        render: function (children) {
          NoopRenderer.updateContainer(children, fiberRoot, null, null);
